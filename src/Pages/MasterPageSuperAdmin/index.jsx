            ...
            <div className="2xl:col-span-18 col-span-12 h-100">
                <div className="col-span-12 ml-5 mb-10 mr-5 h-100">
                    ...
                    <div className="mt-2 border border-none rounded-lg grid lg:grid-cols-18 grid-cols-12 gap-5">
                        <div className="lg:col-span-6 col-span-12 p-5 bg-background-snow rounded-lg">
                            <MasterPageInnerCard title="Total Company" total="10" status="About the same as usual" icon={IconHome}/>
                        </div>
...
export default MasterPageSuperAdmin;