...
import PrintListProjectDashboardWithData from "./PrintListProjectDashboardWithData/PrintListProjectDashboardWithData";


const ProjectOverviewCard = (props) => {
  const { title1, title2, description2, title3, description3 } = props;
  return (
    <div className="bg-white flex shadow-lg justify-between mx-auto items-center align-middle flex-row rounded-lg h-32">
      <div className="py-4 px-12">
        ...
        <div>
        <PrintListProjectDashboardWithData />
        </div>
      </div>
      <div className="py-4 px-12">
