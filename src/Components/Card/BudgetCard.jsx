  ...
  return (
    <div className="bg-white flex shadow-lg justify-between mx-auto rounded-lg items-start align-middle flex-row h-32">
      <div className="py-4 px-4">
        ...
        <div className={`fill-primary text-center items-center m-auto w-24 h-24 ${colorIcon} opacity-50`}>
        <svg xmlns="http://www.w3.org/2000/svg" className="fill-current MuiSvgIcon-root MuiSvgIcon-fontSizeLarge css-6flbmm" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="MonetizationOnTwoToneIcon">
