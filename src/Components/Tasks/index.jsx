    ...
    return (
        ...
        >
            <div className="flex flex-col">
                ...
                <h6 className="text-xs text-grey ">{date}</h6>
            </div>

            <a href="#" key={id} className="flex justify-center align-center opacity-70 hover:opacity-100 transition ease-out duration-100">
