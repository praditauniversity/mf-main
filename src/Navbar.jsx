        ...
        <nav className="flex items-center justify-between flex-wrap bg-indigo-700 p-6">
            ...
            <div className={`${hidden ? 'hidden' : ''} w-full block flex-grow lg:flex lg:items-center lg:w-auto`}>
                <div className="text-sm lg:flex-grow">
                    ...
                    <Link to="/activity" className="block mt-4 lg:inline-block lg:mt-0 text-indigo-200 hover:text-white mr-4">
                        Activity
                    </Link>
                    <Link to="/project" className="block mt-4 lg:inline-block lg:mt-0 text-indigo-200 hover:text-white mr-4">
                        Project
                    </Link>
                    <Link to="/about" className="block mt-4 lg:inline-block lg:mt-0 text-indigo-200 hover:text-white mr-4">
                        About
                    </Link>
                    <Link to="/contact" className="block mt-4 lg:inline-block lg:mt-0 text-indigo-200 hover:text-white">
                        Contact
                    </Link>
                </div>
                <div>
